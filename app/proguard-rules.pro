...
#
-dontwarn com.bozlun.health.android.bean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.bean.** { *; }

-dontwarn com.bozlun.health.android.friend.bean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.friend.bean.** { *; }

-dontwarn com.bozlun.health.android.h9.bean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.h9.bean.** { *; }

-dontwarn com.bozlun.health.android.siswatch.bean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.siswatch.bean.** { *; }

-dontwarn com.bozlun.health.android.w30s.bean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.w30s.bean.** { *; }

-dontwarn com.bozlun.health.android.B18I.b18ibean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.B18I.b18ibean.** { *; }

-dontwarn com.bozlun.health.android.b30.bean.**
#对含有反射类的处理
-keep class com.bozlun.health.android.b30.bean.** { *; }
-keep public class com.bozlun.health.android.b30.bean.**


-dontwarn com.bozlun.health.android.bzlmaps.mapdb.**
#对含有反射类的处理
-keep class com.bozlun.health.android.bzlmaps.mapdb.** { *; }
...
-dontwarn com.bozlun.health.android.activity.wylactivity.wyl_util.**
#对含有反射类的处理
-keep class com.bozlun.health.android.activity.wylactivity.wyl_util.** { *; }
...
-dontwarn com.bozlun.health.android.b30.service.DateUploadService.**
#对含有反射类的处理
-keep class com.bozlun.health.android.b30.service.DateUploadService.** {*;}

#//不混淆某个类
-keep public class com.bozlun.health.android.b30.service.DateUploadService {*;}
#//不混淆某个类的子类
-keep public class * extends com.bozlun.health.android.b30.service.DateUploadService {*;}

#//不混淆某个类的内部类
-keep class com.bozlun.health.android.b30.service.DateUploadService$* {*;}

-dontwarn com.bozlun.health.android.b30.service.NewDateUploadService.**
#对含有反射类的处理
-keep class com.bozlun.health.android.b30.service.NewDateUploadService.** {*;}
...
-dontwarn com.bozlun.health.android.b31.model.**
#对含有反射类的处理
-keep class com.bozlun.health.android.b31.model.** { *; }



#//不混淆某个类的内部类
-keep class com.bozlun.health.android.activity.MyPersonalActivity$* {
        *;
 }
 #//不混淆某个类的内部类
 -keep class com.bozlun.health.android.b30.b30datafragment.B30DataFragment$* {
         *;
  }
