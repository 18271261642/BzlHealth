...
public class NotiMsgFragment extends WatchBaseActivity implements RequestView {
    ...
    private void getMsgData() {
        ...
        String url = "http://47.90.83.197:9080/WatchWeb/notice/getNoticeByAppName?appName=com.bozlun.health.android";
    ...
    private void initViews() {
        ...
        commentB30TitleTv.setText(getResources().getString(R.string.notice_str));
