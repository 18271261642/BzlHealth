...
import static com.bozlun.health.android.bleutil.Customdata.addBytes;
...
//                    , Integer.valueOf(22).byteValue(), (byte) 0x02, Integer.valueOf(22).byteValue(), Integer.valueOf(22).byteValue(), (byte) 0x00, (byte) 0x01};
    ...
    public static void OnekeyMeasurememoren(String name, int id) {
      try{
          SharedPreferences mySharedPre= MyApp.getContext().getSharedPreferences("shousuoya", Activity.MODE_PRIVATE);
          SharedPreferences denglu= MyApp.getContext().getSharedPreferences("shuzhangya", Activity.MODE_PRIVATE);
