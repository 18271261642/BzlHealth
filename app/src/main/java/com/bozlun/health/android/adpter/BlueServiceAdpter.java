...
import com.bozlun.health.android.bean.RssiBluetoothDevice;
...
public class BlueServiceAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (bluetoothDevice != null) {
            ...
            } else if ("H9".equals(bluetoothDevice.getName().substring(0, 4))) {  //H9手表图标
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            bind_btn = (Button) view.findViewById(R.id.bind_btn);
