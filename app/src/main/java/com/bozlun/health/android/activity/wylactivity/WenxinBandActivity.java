...
public class WenxinBandActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        try {
            ...
            //说明绑定的设备是同一个设备
            try {//取得蓝牙的名字和mac
                if (null != SharedPreferencesUtils.readObject(WenxinBandActivity.this,  Commont.BLENAME)) {
                    mDeviceName = (String) SharedPreferencesUtils.readObject(WenxinBandActivity.this,  Commont.BLENAME);//蓝牙的名字
