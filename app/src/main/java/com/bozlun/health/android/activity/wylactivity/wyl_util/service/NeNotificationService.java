...
/*	public  void  sendMsg(String key, String object){
    ...
    public static void sendTo(int id, String msg) {
        ...
        if ("bozlun".equals(SharedPreferencesUtils.readObject(MyApp.getContext(),  Commont.BLENAME))) {
            Log.e("NeNorificationService", "-----1111-----走到这里来了----");
            if ("on".equals(SharedPreferencesUtils.getParam(MyApp.getContext(), "messagealert", ""))) {
