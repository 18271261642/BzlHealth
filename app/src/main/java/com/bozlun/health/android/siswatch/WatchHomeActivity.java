...
import com.bozlun.health.android.siswatch.record.WatchRecordFragment;
import com.bozlun.health.android.siswatch.run.WatchRunFragment;
...
//        MyApp.getCustomPhoneStateListener().setPhoneStateListenerInterface(this);
    ...
    protected void onResume() {
        ...
        if (mBluetoothService != null) {
            ...
            Log.e(TAG,"------mBluetoothService == null--------");
            mBluetoothService = MyApp.getInstance().getWatchBluetoothService();
        }
    ...
    private void initData() {
        mDeviceName = (String) SharedPreferencesUtils.readObject(WatchHomeActivity.this,  Commont.BLENAME);
        mDeviceAddress = (String) SharedPreferencesUtils.readObject(WatchHomeActivity.this, Commont.BLEMAC);
...
//        updateManager.checkForUpdate(false);
    ...
    private void syncUserStepsData(int steps,Map<String,Integer> stpMap) {
        ...
        //设备地址
        String deviceCode = (String) SharedPreferencesUtils.readObject(WatchHomeActivity.this, Commont.BLEMAC);
